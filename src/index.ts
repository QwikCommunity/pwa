...
import type { QwikBuildTarget, QwikVitePlugin } from "@builder.io/qwik/optimizer";
import type { QwikCityPlugin } from "@builder.io/qwik-city/vite";
import path from "node:path";
import fs from "node:fs/promises";
import fg from 'fast-glob'

const tempGenerateFunc: NonNullable<Plugin['generateBundle']> = (() => {}) satisfies Plugin['generateBundle']
